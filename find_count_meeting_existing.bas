...
Sub find_count_meeting_new_existing()
    Dim lastRow As Long
    Dim i As Long
    Dim fso As Object
    Dim oFile As Object
    ...
    fileName = "C:\Users\amonroy.lax\Documents\dev\ebay\count_dict_meeting.txt" ' replace with the path and name of the file you want to save to'
